...
public interface GraphADT<T> {
    ...
    /**
     * * Inserts an edge between two vertices of this graph.* * @param vertex1
     * the first vertex * @param vertex2 the second vertex
     */
    public void addEdge(T vertex1, T vertex2);

    /**
     * * Removes an edge between two vertices of this graph.* * @param vertex1
     * the first vertex * @param vertex2 the second vertex
     */
